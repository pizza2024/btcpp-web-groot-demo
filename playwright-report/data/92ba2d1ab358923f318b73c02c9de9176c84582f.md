...
- Name: reviewer-testing.spec.ts >> 【边界测试用例】 >> B5-选中文本时Delete键不触发节点删除
- Location: tests/reviewer-testing.spec.ts:641:3
...
Call log:
  - waiting for getByRole('menuitem', { name: '➕ Add Node' })
