...
- Name: reviewer-testing.spec.ts >> 【Model类型节点连线规则测试】 >> M7-Control节点可有多子节点: Sequence可以有多个子节点
- Location: tests/reviewer-testing.spec.ts:244:3
  ...
  - generic [ref=e18]:
    ...
    - generic [ref=e193]:
      - generic [ref=e194]:
        ...
        - 'generic "Unconnected nodes: AsyncSequence" [ref=e222]':
          - generic [ref=e223]: ⚠️
