...
- Name: reviewer-testing.spec.ts >> 【基础功能测试】节点生成、连线生成、节点删除、连线删除 >> T2-节点生成: 点击画布空白区域打开节点选择器添加节点
- Location: tests/reviewer-testing.spec.ts:99:3
...
Call log:
  - waiting for locator('.node-picker-item').filter({ hasText: 'Fallback' }).first()
  ...
  - generic [ref=e18]:
    ...
    - generic [ref=e193]:
      - application [ref=e195]:
        ...
        - img
        - generic "Control Panel" [ref=e201]:
          ...
          - button "Fit View" [ref=e205] [cursor=pointer]:
            - img [ref=e206]
          - button "Toggle Interactivity" [ref=e208] [cursor=pointer]:
            - img [ref=e209]
        - generic: 200%
        - img "Mini Map" [ref=e212]
      - generic [ref=e215]:
        - generic [ref=e216] [cursor=pointer]:
          - generic [ref=e217]: ⭐ Favorites (0)
          - button "✕" [ref=e218]
        - generic [ref=e220]: No favorites yet. Right-click a node to save it.
    - generic [ref=e221]:
      - generic [ref=e222]:
        - generic [ref=e223] [cursor=pointer]: Properties
        - generic [ref=e224]: Select a node on the canvas to view its properties.
      - generic [ref=e225]:
        - generic [ref=e226] [cursor=pointer]: Debug / Log Replay
        - generic [ref=e227]:
          - button "Sample Log" [ref=e228] [cursor=pointer]
          - button "Load File" [ref=e229] [cursor=pointer]
          - button "Paste Log" [ref=e230] [cursor=pointer]
        - generic [ref=e231]:
