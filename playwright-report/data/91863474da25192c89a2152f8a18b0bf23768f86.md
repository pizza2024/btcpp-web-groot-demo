...
- Name: reviewer-testing.spec.ts >> 【Model类型节点连线规则测试】 >> M8-Fallback节点可有多子节点
- Location: tests/reviewer-testing.spec.ts:255:3
...
Call log:
  - waiting for locator('.palette-item').filter({ hasText: 'Condition1' }).first()
